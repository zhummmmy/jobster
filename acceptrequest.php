...
$result2 = mysqli_query($con, "INSERT INTO friend values('$uid','$fid','accepted',now())");
$result3 = mysqli_query($con, "INSERT INTO friend values('$fid','$uid','accepted',now())");
...
?>
  ...
  <a href="notification.php?sid=<?php echo $uid ?>" style="text-decoration: none; color: black;">
   ...
   <div class = "middle">
    ...
    <hr>
    <p>Your has added this friend successfully!</p>
